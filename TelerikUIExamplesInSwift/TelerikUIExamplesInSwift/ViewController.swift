...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func initExamples() {
        ...
        examples.append(ExampleInfo(title: "ListView", exampleList: [
            ...
            ExampleInfo(title: "Variable item height") { ListViewVariableHeight() },
            ExampleInfo(title: "Performance") { ListViewPerformance() },
            ExampleInfo(title: "Add/Remove/Update items") { ListViewUpdate() },
            ]))
