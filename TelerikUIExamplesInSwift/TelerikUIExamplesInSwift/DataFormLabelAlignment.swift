...
class DataFormLabelAlignment: TKExamplesExampleViewController, TKDataFormDelegate {
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: NSBundle?) {
        ...
        self.addOption("Top Alignment", action:prepareTopAlignment)
        self.addOption("Left Alignment", action:prepareLeftAlignment)
        self.addOption("Top Inline Alignment", action:prepareTopInlineAlignment)
        self.addOption("Table View Layout", action:prepareTableLayout)
    }
