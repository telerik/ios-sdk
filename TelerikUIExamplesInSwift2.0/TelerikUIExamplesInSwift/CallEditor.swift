...
class CallEditor: TKDataFormEditor {
    ...
    override func layoutSubviews() {
        ...
        let bounds = CGRectMake(self.bounds.origin.x + self.style.insets.left, self.bounds.origin.y + self.style.insets.top,
        ...
        let buttonSize = (actionButton.titleLabel!.text! as NSString)
