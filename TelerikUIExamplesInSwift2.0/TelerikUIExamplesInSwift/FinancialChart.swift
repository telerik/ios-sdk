...
class FinancialChart: ExampleViewController {
    ...
    func reloadChart() {
        ...
        chart.yAxis.style!.labelStyle!.textAlignment = TKChartAxisLabelAlignment(rawValue:TKChartAxisLabelAlignment.Bottom.rawValue |
            TKChartAxisLabelAlignment.Right.rawValue)
