...
namespace Examples
{
	public class DataFormAlignment : ExampleViewController
	{
		TKDataForm dataForm;
		...
		private void PrepareTopAlignment (object sender, EventArgs e)
		{
			this.alignment = "Top";
			this.dataForm.ReloadData ();
		}
			
		private void PrepareLeftAlignment (object sender, EventArgs e) 
		{
			this.alignment = "Left";
			this.dataForm.ReloadData ();
		}
			
		private void PrepareTopInlineAlignment (object sender, EventArgs e)
		{
			this.alignment = "TopInline";
			this.dataForm.ReloadData ();
		}
			
		private void PrepareTableLayout (object sender, EventArgs e) 
		{
	...
	{
		DataFormAlignment owner;

		public DataFormAlignmentDelegate(DataFormAlignment owner) {
			this.owner = owner;
		}
